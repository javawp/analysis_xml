...
public class Demo01 {
	...
	public void test() throws Exception {
		...
		InputStream in = Demo01.class.getClassLoader().getResourceAsStream("dom4j/sida.xml");
		...
		// 返回true代码删除成功，否则失败
		System.out.println("删除元素节点是否成功: " + flag);
		// 添加CDATA区域
...
//		XMLWriter writer = new XMLWriter(new FileWriter(new File("src//a.xml")), format);
		XMLWriter writer = new XMLWriter(new OutputStreamWriter(new FileOutputStream(new File("src/dom4j/a.xml")), "UTF-8"), format);
		// 写入
